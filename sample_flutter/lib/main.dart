...
class _MyHomePageState extends State<MyHomePage> {
  List<String> devices = List<String>.empty(growable: true);
        ...
        child: Column(
          ...
          children: <Widget>[
            TextButton(
                  ...
                  flutterBlue.scanResults.listen((results) {
                    for (ScanResult result in results) {
                      ...
                      AlertDialog alert = AlertDialog(
                        ...
                        content: Text(result.device.name),
                        actions: [
                          okButton,
                        ],
                      );
                ...
                child: Text("Scan devices near me")),
            ListView(
              shrinkWrap: true, // use this
              children: devices.map((device) => Text(device)).toList(),
            )
          ],
        ),
      ),
